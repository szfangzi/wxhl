...
<div class="ibody">
  <header>
    ...
    <nav id="topnav"><a href="<?php echo U('Index/Index/index');?>">首页</a><a href="<?php echo U('Index/About/index');?>">关于我</a><a href="<?php echo U('Index/List/index');?>">慢生活</a></nav>
  </header>


<link href="__PUBLIC__/css/about.css" rel="stylesheet">
<article>
  <h2 class="about_h">您现在的位置是：<a href="/">首页</a>><a href="1/">关于我</a></h2>
  <div class="about">
    <h2>Just about me</h2>
    <ul>
