						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									...
									<?php if($posts != NULL): ?><table id="postsList" class="table table-striped table-bordered table-hover">
											<thead>
												<tr>
													<th class="center">
											...
											<?php if(is_array($posts)): foreach($posts as $k=>$v): ?><tr class="item">
													<td class="center">
														<input type="hidden" value="<?php echo ($v["id"]); ?>" class="postId" />
														<label class="position-relative">
															<input type="checkbox" class="ace">
															<span class="lbl"></span>
														</label>
													...
													<td>
														<div class="hidden-sm hidden-xs btn-group">
															...
															<a href="<?php echo U('Admin/Posts/post');?>?id=<?php echo ($v["id"]); ?>&edit=1" class="btn btn-xs btn-info">
																<i class="ace-icon fa fa-pencil bigger-120"></i>
															</a>

															<a href="javascript:;" class="btn btn-xs btn-danger postDelBtn">
...
<![endif]-->
		...
		<script type="text/javascript">
		var postDelUrl = "<?php echo U('Admin/Posts/delete');?>";
