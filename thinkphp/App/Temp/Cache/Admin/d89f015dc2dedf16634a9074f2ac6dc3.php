...
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT STARTS -->
		<?php if($nodes != NULL): ?><table id="nodesList" class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						<th class="center">
				...
				<?php if(is_array($nodes)): foreach($nodes as $k=>$app): ?><tr class="item">
						<td class="center">
							<input type="hidden" value="<?php echo ($app["id"]); ?>" class="nodeId" />
							<label class="position-relative">
								<input type="checkbox" class="ace">
								<span class="lbl"></span>
							</label>
						...
						<td>
							<div class="hidden-sm hidden-xs action-buttons">
								...
								<a href="<?php echo U('Admin/Rbac/addNode', array('id'=>$app['id'], 'edit'=>1, 'level'=>($app['level']) ));?>" class="green">
								...
								<?php if($app['level'] != 3){ ?>
								<a href="<?php echo U('Admin/Rbac/addNode', array('pid'=>$app['id'], 'level'=>($app['level']+1) ));?>" class="blue" title="添加控制器">
...
<![endif]-->
  ...
  <script type="text/javascript">
  	var nodeDelUrl = "<?php echo U('Admin/Rbac/delNode');?>";
