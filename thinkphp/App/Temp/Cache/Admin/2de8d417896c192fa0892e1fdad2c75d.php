...
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT STARTS -->
		<?php if($roles != NULL): ?><table id="rolesList" class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						<th class="center">
				...
				<?php if(is_array($roles)): foreach($roles as $k=>$v): ?><tr class="item">
						<td class="center">
							<input type="hidden" value="<?php echo ($v["id"]); ?>" class="roleId" />
							<label class="position-relative">
								<input type="checkbox" class="ace">
								<span class="lbl"></span>
							</label>
						...
						<td>
							<div class="hidden-sm hidden-xs action-buttons">
								...
								<a href="<?php echo U('Admin/Rbac/addRole', array('id'=>$v['id'], 'edit'=>1));?>" class="green">
								...
								<a href="<?php echo U('Admin/Rbac/access', array('rid'=>$v['id']) );?>" class="blue" title="配置权限">
...
<![endif]-->
  ...
  <script type="text/javascript">
  	var roleDelUrl = "<?php echo U('Admin/Rbac/delRole');?>";
