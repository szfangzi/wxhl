...
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT STARTS -->
		<form class="form-horizontal" role="form" method="post" action="<?php echo U('Admin/Index/index');?>">
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="width"> 宽度 </label>

				<div class="col-sm-9">
					<input type="text" id="width" name="width" value="<?php echo ($test["width"]); ?>" placeholder="width" class="col-xs-10 col-sm-5">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="height"> 高度 </label>

				<div class="col-sm-9">
					<input type="text" id="height" name="height" value="<?php echo ($test["height"]); ?>" placeholder="height" class="col-xs-10 col-sm-5">
				</div>
			</div>
