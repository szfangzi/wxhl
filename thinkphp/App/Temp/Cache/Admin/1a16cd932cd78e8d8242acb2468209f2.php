...
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT STARTS -->
		<form class="form-horizontal" role="form" method="post" action="<?php echo U('Admin/Rbac/addRole');?>">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="roleName" name="name" value="<?php echo ($role["name"]); ?>" placeholder="roleName" class="col-xs-10 col-sm-5">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="remark"> 角色描述 </label>

				<div class="col-sm-9">
					<textarea class="form-control" style="max-width:41.666%;" id="remark" name="remark" placeholder="remark"><?php echo ($role["remark"]); ?></textarea>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<label class="pull-left inline">
						<input id="roleSwitchBtn" type="checkbox" class="ace ace-switch ace-switch-5" name="status">
