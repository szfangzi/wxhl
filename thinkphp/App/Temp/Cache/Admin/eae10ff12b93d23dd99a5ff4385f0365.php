										...
										<div class="widget-main">
											...
											<form action="<?php echo U('Login/login');?>" method="post" id="loginForm">
												<fieldset>
													...
													<label class="block clearfix">
														<span class=" input-icon input-icon-right" style="    width: 230px;">
															<input type="verify" class="form-control" placeholder="" name="verify" />
														</span>
														<img name="verify" src="<?php echo U('Login/verify');?>" style="float: right;cursor:pointer" id="verifyImg">
													</label>
													<div class="clearfix">
...
<![endif]-->
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
			 $(document).on('click', '#verifyImg', function(e) {
				e.preventDefault();
				var $this = $(this);
